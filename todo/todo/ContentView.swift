...
struct cellview : View {
    ...
    var body : some View{
        ...
        HStack{
            ...
            .background(RoundedRectangle(cornerRadius: 25).fill(Color(#colorLiteral(red: 0.8705882353, green: 0.8705882353, blue: 0.9098039216, alpha: 1))))
            .animation(Animation.easeInOut(duration: 0.6))
            .shadow(color: Color.black.opacity(0.2), radius: 10, x: 10, y: 10)
            .shadow(color: Color.white.opacity(1.0), radius: 10, x: -5, y: -5)
    }
}
